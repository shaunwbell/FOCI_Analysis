...
ncfile_all = ['/Users/bell/Data_Local/sst/NOAA_OI_SST_V2/sst.day.anom.2011.v2.nc', \
          '/Users/bell/Data_Local/sst/NOAA_OI_SST_V2/sst.day.anom.2012.v2.nc', \
          '/Users/bell/Data_Local/sst/NOAA_OI_SST_V2/sst.day.anom.2013.v2.nc', \
          '/Users/bell/Data_Local/sst/NOAA_OI_SST_V2/sst.day.anom.2014.v2.nc', \
          '/Users/bell/Data_Local/sst/NOAA_OI_SST_V2/sst.day.anom.2015.v2.nc', ]
...
for ncfile in ncfile_all:
    ...
    for ind in range(0,365):
        ...
        (topoin, elats, elons) = (MapData['anom'], MapData['lat'], MapData['lon'])
        ...
        CS_l = m.contour(ex,ey,topoin, levels=[-4,-3,-2,-1,0,1,2,3,4,], linestyle='--', linewidths=1, colors='black', alpha=.75) 
        CS_l = m.contour(ex,ey,topoin, levels=[0,], linestyle='--', linewidths=1.25, colors='black') 
        im1 = m.pcolormesh(ex,ey,topoin,vmin=-4,vmax=4,cmap=plt.cm.RdBu_r)
        ...
        plt.savefig('images/sst_anom/' + time_label + '_anom_sst_map.png', bbox_inches='tight', dpi = (300))
        plt.close()
