...
class EPIC_NC_Cloud(object):
    ...
    def file_create(self):
        ...
        rootgrpID = Dataset(self.savefile, EPIC_NC_Cloud.nc_read, format=EPIC_NC_Cloud.nc_format)
        self.rootgrpID = rootgrpID
        return ( rootgrpID )
    ...
    def variable_init(self):
        ...
        #build record variable attributes
        rec_vars, rec_var_name, rec_var_longname = ['LC_001', 'MC_002','HC_003'], ['LC', 'MC','HC'], ["LOW CLOUD AREA FRACTION","MIDDLE CLOUD AREA FRACTION","HIGH CLOUD AREA FRACTION"]
        rec_var_generic_name, rec_var_FORTRAN, rec_var_units, rec_var_epic = ['lc','mc','hc'], ['','',''], ['%','%','%'], [001,002,003]
