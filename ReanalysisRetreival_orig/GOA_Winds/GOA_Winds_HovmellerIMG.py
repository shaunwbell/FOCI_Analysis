...
fig = plt.figure()
ax = plt.subplot(111)
plt.imshow(NARR_mag_array,cmap='jet_r', aspect=20, 
...
plt.title('NARR Wind Magnitude at Globec3 \n')

DefaultSize = fig.get_size_inches()
fig.set_size_inches( (DefaultSize[0]*2, DefaultSize[1]*2) )
plt.savefig('NARR_globec_windmag.png', bbox_inches='tight', dpi = (100))
plt.close()