...
class EPIC_NC(object):
    ...
    def variable_init(self):
        ...
        rec_vars, rec_var_name, rec_var_longname = ['WU_422', 'WV_423'], ['WU', 'WV'], ["WIND U (M/S)             ","WIND V (M/S)             "]
        rec_var_generic_name, rec_var_FORTRAN, rec_var_units, rec_var_epic = ['u','v'], ['',''], ['m s-1','m s-1'], [422,423]
